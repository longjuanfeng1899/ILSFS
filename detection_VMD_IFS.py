...
def plot_log_likelihood(df_log_px):
    ...
    # plt.savefig('output/VMD/log_likelihood_VMD_IFS_'+id+'.png')
def main():
    # coverage rate thresholds=70
    # all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
    #                      usecols=['TIMESTAMP', 'ZD_P', 'L0014', 'L0015', 'L0016','L0040','L0042','L0059',
    #                               'L0064','L0069','L0137','L0142','L0147'])
    # coverage rate thresholds=50
    # all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
    #                      usecols=['TIMESTAMP', 'ZD_P', 'L0014', 'L0015', 'L0016', 'L0040', 'L0042', 'L0059',
    #                               'L0064', 'L0069', 'L0137','L0138', 'L0142', 'L0147'])
    # coverage rate thresholds=30
    all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
                         usecols=['TIMESTAMP', 'ZD_P', 'L0014', 'L0015', 'L0016', 'L0039','L0040', 'L0042', 'L0056','L0059',
                                  'L0064', 'L0069','L0070', 'L0137', 'L0138','L0142', 'L0147'])
    ...
    # plt.savefig('output/VMD/anomaly_lstm_vae_VMD_IFS_'+id+'.png')
    # df_log_px.to_csv("output/VMD/Anomaly_lstm_vae_VMD_IFS_70_"+id+".csv")
    # df_log_px.to_csv("output/VMD/Anomaly_lstm_vae_VMD_IFS_50_" + id + ".csv")
    df_log_px.to_csv("output/VMD/Anomaly_lstm_vae_VMD_IFS_30_" + id + ".csv")
