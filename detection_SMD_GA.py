...
def sample_z(args):
    ...
    # epsilon = tf.random.normal(shape=(10, 9), mean=0.0, stddev=1.0)
    # coverage rate thresholds=50
    # epsilon = tf.random.normal(shape=(10, 18), mean=0.0, stddev=1.0)
    # coverage rate thresholds=30
    epsilon = tf.random.normal(shape=(10, 30), mean=0.0, stddev=1.0)
...
def main():
    ...
    #                      usecols=['timestamp', 'col_0', 'col_2', 'col_5','col_12', 'col_15', 'col_19', 'col_22','col_30','col_32'])
    # coverage rate thresholds=50
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_0', 'col_2','col_4','col_5','col_7', 'col_11', 'col_12', 'col_15', 'col_19',
    #                               'col_22','col_23','col_25', 'col_29', 'col_30','col_32', 'col_34','col_35','col_36'])
    # coverage rate thresholds=30
    all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
                         usecols=['timestamp', 'col_0','col_1','col_2','col_4','col_5','col_7','col_8','col_11','col_12', 'col_13',
                         'col_14','col_15','col_16','col_17','col_19','col_20','col_21', 'col_22','col_23','col_25', 'col_26','col_28',
    ...
    history = model.fit(train_scaled, train_scaled, epochs=50,  batch_size=10, verbose=2,validation_split=0.2)
    ...
    df_log_px.to_csv("output/SMD/GA/Anomaly_lstm_SMD_GA_30_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/GA/Anomaly_lstm_SMD_GA_50_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/GA/Anomaly_lstm_SMD_GA_70_" + id + ".csv")
