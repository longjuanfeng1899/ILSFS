...
def sample_z(args):
    ...
    # epsilon = tf.random.normal(shape=(10, 19), mean=0.0, stddev=1.0)
...
def main():
    ...
    #                      usecols=['timestamp', 'col_0', 'col_2','col_3','col_5', 'col_6','col_8', 'col_9','col_11','col_12', 'col_13', 'col_14', 'col_18','col_19',
    #                               'col_25','col_29','col_31','col_34'])
    # coverage rate thresholds=50
    all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
                         usecols=['timestamp', 'col_0', 'col_2','col_3','col_5', 'col_6','col_8', 'col_9','col_11','col_12', 'col_13', 'col_14', 'col_18','col_19',
                                      'col_25','col_29','col_31','col_32','col_34'])
    # coverage rate thresholds=30
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_0', 'col_2','col_3','col_5', 'col_6','col_8', 'col_9','col_11','col_12', 'col_13', 'col_14', 'col_18','col_19',
    #                                   'col_23','col_25','col_29','col_31','col_32','col_34'])
    ...
    # df_log_px.to_csv("output/SMD/BRU/Anomaly_lstm_SMD_BRU_30_" + id + ".csv")
    df_log_px.to_csv("output/SMD/BRU/Anomaly_lstm_SMD_BRU_50_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/BRU/Anomaly_lstm_SMD_BRU_70_" + id + ".csv")
