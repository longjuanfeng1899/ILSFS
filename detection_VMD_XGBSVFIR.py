...
def sample_z(args):
    ...
    # epsilon = tf.random.normal(shape=(10, 14), mean=0.0, stddev=1.0)
...
def main():
    ...
    all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
                         usecols=['TIMESTAMP', 'L0014','L0018','L0039','L0040','L0042','L0064','L0069','L0070','L0147'])
    # coverage rate thresholds=50
    # all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
    #                      usecols=['TIMESTAMP', 'L0014','L0015','L0018','L0039','L0040','L0041','L0042','L0049','L0050','L0064','L0069','L0070','L0144','L0147'])
    # coverage rate thresholds=30
    # all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
    #                      usecols=['TIMESTAMP', 'ZD_P', 'L0014','L0015','L0018','L0039','L0040','L0041','L0042','L0049','L0050','L0064','L0069','L0070','L0143','L0144','L0147'])
    ...
    df_log_px.to_csv("output/VMD/XGBSVFIR/Anomaly_lstm_vae_VMD_XGBSVFIR_70_"+id+".csv")
    # df_log_px.to_csv("output/VMD/XGBSVFIR/Anomaly_lstm_vae_VMD_XGBSVFIR_50_" + id + ".csv")
    # df_log_px.to_csv("output/VMD/XGBSVFIR/Anomaly_lstm_vae_VMD_XGBSVFIR_30_" + id + ".csv")
