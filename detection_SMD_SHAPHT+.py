...
def sample_z(args):
    ...
    epsilon = tf.random.normal(shape=(10, 15), mean=0.0, stddev=1.0)
...
def main():
    ...
    all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
                         usecols=['timestamp', 'col_1','col_2','col_3','col_5','col_6','col_8','col_10', 'col_13',
                             'col_14','col_15','col_18','col_19', 'col_21','col_30','col_34'])
    # coverage rate thresholds=50
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_1','col_2','col_3','col_5','col_6','col_8','col_10', 'col_13',
    #                              'col_14','col_15','col_18','col_19', 'col_21','col_30','col_34','col_35'])
    # coverage rate thresholds=30
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_1','col_2','col_3','col_5','col_6','col_8','col_10', 'col_13',
    #                              'col_14','col_15','col_18','col_19', 'col_21','col_30','col_31','col_34','col_35'])
    ...
    # df_log_px.to_csv("output/SMD/ShapHT+/Anomaly_lstm_SMD_ShapHT_30_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/ShapHT+/Anomaly_lstm_SMD_ShapHT_50_" + id + ".csv")
    df_log_px.to_csv("output/SMD/ShapHT+/Anomaly_lstm_SMD_ShapHT_70_" + id + ".csv")
