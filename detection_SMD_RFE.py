...
def main():
    ...
    #                      usecols=['timestamp', 'col_0', 'col_3', 'col_5','col_6','col_8', 'col_11', 'col_13', 'col_14', 'col_18','col_19','col_23',
    #                               'col_25','col_29','col_31','col_34'])
    # coverage rate thresholds=50
    all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
                         usecols=['timestamp', 'col_0', 'col_3', 'col_5','col_6','col_8', 'col_11', 'col_13', 'col_14', 'col_18','col_19','col_23',
                                      'col_25','col_29','col_31','col_34'])
    # coverage rate thresholds=30
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_0', 'col_2','col_3', 'col_5','col_6','col_8', 'col_9','col_11', 'col_12','col_13', 'col_14','col_15',
    #                      'col_18','col_19','col_22','col_23','col_24','col_25','col_29','col_31','col_34'])
    ...
    # df_log_px.to_csv("output/SMD/RFE/Anomaly_lstm_SMD_RFE_30_" + id + ".csv")
    df_log_px.to_csv("output/SMD/RFE/Anomaly_lstm_SMD_RFE_50_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/RFE/Anomaly_lstm_SMD_RFE_70_" + id + ".csv")
