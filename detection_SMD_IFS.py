...
def sample_z(args):
    ...
    # epsilon = tf.random.normal(shape=(10, 12), mean=0.0, stddev=1.0)
    # coverage rate thresholds=50
    # epsilon = tf.random.normal(shape=(10, 13), mean=0.0, stddev=1.0)
    # coverage rate thresholds=30
    epsilon = tf.random.normal(shape=(10, 17), mean=0.0, stddev=1.0)
...
def plot_log_likelihood(df_log_px):
    ...
    # plt.savefig('output/SMD/log_likelihood_SMD_IFS_'+id+'.png')
def main():

    # coverage rate thresholds=70
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_1','col_2', 'col_6','col_8', 'col_12', 'col_13', 'col_14', 'col_18','col_22','col_29','col_32','col_34'])
    # coverage rate thresholds=50
    # all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
    #                      usecols=['timestamp', 'col_1', 'col_2', 'col_6', 'col_8','col_10', 'col_12', 'col_13', 'col_14',
    #                               'col_18', 'col_22', 'col_29', 'col_32', 'col_34'])
    # # coverage rate thresholds=30
    all_df = pd.read_csv('dataset/SMD/machine-1-1.csv', index_col='timestamp',
                         usecols=['timestamp', 'col_1', 'col_2', 'col_6', 'col_8', 'col_10', 'col_12', 'col_13',
                                  'col_14','col_15','col_18', 'col_22','col_25', 'col_29','col_31', 'col_32', 'col_34','col_35'])
    ...
    # plt.savefig('output/SMD/anomaly_lstm_SMD_IFS_'+id+'.png')

    df_log_px.to_csv("output/SMD/Anomaly_lstm_SMD_IFS_30_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/Anomaly_lstm_SMD_IFS_50_" + id + ".csv")
    # df_log_px.to_csv("output/SMD/Anomaly_lstm_SMD_IFS_70_" + id + ".csv")
