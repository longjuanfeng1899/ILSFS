...
def main():
    ...
    all_df = pd.read_csv('dataset/VMD/limo_relation_data_6.14_2.csv', index_col='TIMESTAMP',
                         usecols=['TIMESTAMP', 'ZD_P','L0016','L0019','L0020', 'L0040', 'L0042','L0052','L0054','L0056','L0057','L0059', 'L0064', 'L0069', 'L0070',
                                  'L0139','L0141','L0147'])
    ...
    df_log_px.to_csv("output/VMD/ShapHT+/Anomaly_lstm_vae_VMD_ShapHT_70_" + id + ".csv")
    # df_log_px.to_csv("output/VMD/ShapHT+/Anomaly_lstm_vae_VMD_ShapHT_50_" + id + ".csv")
    # df_log_px.to_csv("output/VMD/ShapHT+/Anomaly_lstm_vae_VMD_ShapHT_30_" + id + ".csv")
